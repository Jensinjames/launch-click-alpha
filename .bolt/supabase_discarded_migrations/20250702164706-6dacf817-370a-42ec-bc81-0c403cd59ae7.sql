-- Add missing RLS policies for enhanced security (corrected table names)
...
-- 2. Add team-context policies for generated_content access (using correct table name)
CREATE POLICY "Team members can view team content" 
ON public.app_38b06dea2963452f9265ca4a0de19e02_generated_content 
FOR SELECT 
USING (
  (user_id = auth.uid()) OR 
  (team_id IS NOT NULL AND EXISTS (
    SELECT 1 FROM app_38b06dea2963452f9265ca4a0de19e02_team_members 
    WHERE team_id = app_38b06dea2963452f9265ca4a0de19e02_generated_content.team_id 
