-- Phase 1: Remove duplicate prefixed tables that are not being used by the application
...
VACUUM FULL user_preferences;
VACUUM FULL user_credits;
VACUUM FULL profiles;
VACUUM FULL content_templates;
VACUUM FULL feature_hierarchy;