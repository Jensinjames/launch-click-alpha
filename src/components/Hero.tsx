...
const Hero = () => {
  return <section className="relative overflow-hidden pt-16 pb-24">
        ...
        <div className="text-center">
          <div className="flex justify-center mb-6">
            <div className="w-16 h-16 gradient-rocket rounded-xl flex items-center justify-center shadow-lg">
              <img src={launchClickLogo} alt="LaunchClick" className="w-10 h-10 filter brightness-0 invert object-scale-down" />
            </div>
          </div>
          ...
          <h2 className="text-2xl md:text-3xl font-semibold mb-8" style={{
          color: '#227CFF'
        }}>
