-- Update create_team_with_access_control function to accept user_id parameter (fixed parameter order)
CREATE OR REPLACE FUNCTION public.create_team_with_access_control(
  p_team_name TEXT,
  p_user_id UUID, -- Move user_id before description
